function [nodeA_tx_data_timestamps, ...
	...
	nodeB_rx_data_goodcrc_unique_messagelengths] = get_performance_source(nodeA_log, nodeB_log, nodeA_ID, nodeB_ID, source_ID, pktCode, inittime)
%%
...
ii_refined = refine_log(nodeA_log(ii_valid),'sourceID',source_ID);
...
ii_refined = refine_log(nodeB_log(ii_rx_data_goodcrc),'sourceID',source_ID);
